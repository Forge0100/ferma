function pay_pol_new(num, type, is_build){
	...
	{
		if(type == 1) var type_str = 'Блинчик с мясом';
		if(type == 2) var type_str = 'Блинчик с сыром';
		if(type == 3) var type_str = 'Блинчик с сметаной';
...
function fix_tab(num){
	...
	/*if(num <= 200) $('#pole1').css({'display':'block'});
	if(num > 200 && num <= 380) $('#pole2').css({'display':'block'});
	if(num > 380 && num <= 560) $('#pole3').css({'display':'block'});
	if(num > 560 && num <= 740) $('#pole4').css({'display':'block'});*/
}
