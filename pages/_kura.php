<div class="tegname"><h2>Загон Кур.</h2></div><br>
<?php
...
<a class="tooltip" href="javascript:void(0)">Загон Кур [?]<span class="custom help" style="width: 450px;"><em>Информация</em>В каждый загоне можно посадить 9 кур.<br>
	...
	Каждое кормление забирает 2 ед. энергии и дает 1 ед. опыта.<br>
	Каждый сбор продукта забирает 2 ед. энергии и дает 2 ед. опыта.<br>
</span></a>
